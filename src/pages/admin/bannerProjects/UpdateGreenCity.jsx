...
const UpdateGreenCity = () => {
  ...
  const { updateGreenCity,isLoading } = useGreenCityStore();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateGreenCity(id, formData);
      toast.success("Green City Video updated successfully!");

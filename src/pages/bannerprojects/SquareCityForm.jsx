...
import squareCityMap from "../../assets/squareCityMap.png";
import { IoCloseOutline } from "react-icons/io5";
const SquareCityForm = () => {
  ...
  return (
    <div> <div className="max-w-screen-xl mx-auto flex flex-col justify-center items-center">
          <img src={squareCityMap} />
          <div className="py-4">
            <button onClick={handleOpen} className="py-2 px-8 bg-[#ffc107] rounded-[5px]">
              PRIZE LIST
            </button>
          </div>
        </div>

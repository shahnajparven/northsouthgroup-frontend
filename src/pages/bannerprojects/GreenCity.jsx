  ...
  return (
    <>
      ...
      <div className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-screen overflow-hidden">
        {greenCity?.map((green, idx) => (
          <div key={idx} className="w-full h-full relative">
            <video
              src={green.greenCityVideo}
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-4">
              <img
                src={greenCityImg}
                alt="Logo"
                className="w-24 h-24 sm:w-28 sm:h-28 md:w-36 md:h-36 lg:w-48 lg:h-48 object-contain rounded-[15px]"
              />
              <button
                onClick={handleOpen}
      ...
      <div className="max-w-screen-xl mx-auto py-12 px-4 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2 bg-white px-6 sm:px-12 py-8 rounded-lg shadow">
          ...
          <p className="text-base sm:text-lg text-justify">
            “North South Green City” started in 2021, spanning 600 acres in Bhulta-Gausia along Dhaka-Sylhet Highway.
          </p>
        ...
        <div className="lg:w-1/2 bg-green-100 px-6 sm:px-12 py-8 rounded-lg shadow">
          ...
          <p className="text-base sm:text-lg mb-4 text-justify">
            Eco-friendly layout with RAJUK compliance and planned urbanization.
          </p>
          <p className="text-base sm:text-lg mb-4 text-justify">
            Civic infrastructure, parks, playgrounds, and a 3km lake with walkways.
          </p>
          <p className="text-base sm:text-lg text-justify">
            Zones for education, healthcare, shopping, community centers, and mosques.
          </p>
          <button className="mt-6 bg-[#ffc107] hover:bg-[#e0a800] transition-all px-6 py-3 rounded-md font-medium">
            Read More
          </button>
      ...
      <div className="max-w-screen-xl mx-auto py-12 px-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-base sm:text-lg text-justify">
            Purbachal Northsouth Green City is located on the eastern side of River Shitalakhya...
          </p>
        </div>
      </div>
      ...
      <div className="max-w-screen-xl mx-auto py-12 px-4 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2 flex flex-col justify-center items-center lg:items-start">
          <h1 className="text-2xl sm:text-3xl mb-4 text-[#212529] text-center lg:text-left">RULES & REGULATION</h1>
        ...
        <div className="lg:w-1/2 flex justify-center items-center">
          <div className="relative w-full max-w-md">
            ...
            />
            <a
              href="/green-city-brochure.pdf"
              download
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-green-700 transition font-semibold"
            >
              Download Brochure
            </a>
          </div>

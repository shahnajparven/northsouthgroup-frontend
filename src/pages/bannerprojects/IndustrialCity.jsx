...
import industrialCityBrochure from '../../assets/images/squareCityBrochure.png';
  ...
  return (
    <>
      ...
      <div className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
        {industrialCity?.map((industrial, idx) => (
          <div key={idx} className="w-full h-full relative">
            <video
              src={industrial.industrialCityVideo}
      ...
      <div className="max-w-screen-xl mx-auto py-12 px-4 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2 bg-white px-6 sm:px-12 py-8 rounded-lg shadow">
          ...
          <p className="text-base sm:text-lg mb-4 text-justify">
            North South Group is a market leader in the real estate building and land development sector, gaining strong confidence in housing.
          </p>
          <p className="text-base sm:text-lg text-justify">
            “North South Industrial City” is another milestone project spanning 600 acres along Dhaka-Sylhet Highway.
          </p>
        ...
        <div className="lg:w-1/2 bg-green-100 px-6 sm:px-12 py-8 rounded-lg shadow">
          ...
          <p className="text-base sm:text-lg mb-4 text-justify">
            Eco-friendly layout planning based on RAJUK rules and expert urban planning guidelines.
          </p>
          <p className="text-base sm:text-lg mb-4 text-justify">
            Space allocated for civic infrastructure, parks, playgrounds, and a 3 km long lake with walkways.
          </p>
          <p className="text-base sm:text-lg text-justify">
      ...
      <div className="max-w-screen-xl mx-auto py-12 px-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-base sm:text-lg text-justify">
            Purbachal Industrial City is located on the eastern side of River Shitalakhya, opposite Army Housing Jolshiri Abason Project-2. Accessible via Purbachal Link Road, Kuril Flyover, and Kanchan Bridge.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-screen-xl mx-auto py-12 px-4 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2 flex flex-col justify-center items-center lg:items-start">
          ...
          <p className="text-base sm:text-lg text-justify mb-4">
            RAJUK exercises development control as per East Bengal Building Construction Act, 1952 and its guidelines.
          </p>
